//I changed this file so that when a button wired to GP0_3 is pressed, the third internal LED will light up
...
int main(int argc, char *argv[]) {
    ...
    // I cahnged the mapping to GPIO1 instead of GPIO0
    ...
    while(keepgoing) {
	//Changed the line below so that events on GPIO1_25 will cause the LED to turn on
    	if(*gpio_datain & GPIO1_25) {
